...
public:
    size_t size() const
    {
        rec_lock lock {m_atom_diff_frames_mutex};
    ...
    {
        rec_lock lock {m_atom_diff_frames_mutex};
        rec_lock lock1 {m_first_outdated_frame_mutex};
    ...
    {
        rec_lock lock {m_first_outdated_frame_mutex};
