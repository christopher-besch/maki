...
struct EventHandler {
    ...
    std::function<bool(MouseBtn btn)>                     on_mouse_btn_pressed {nullptr};
    std::function<bool(MouseBtn btn)>                     on_mouse_btn_release {nullptr};
    std::function<bool(Key key)>                          on_key_pressed {nullptr};
    std::function<bool(Key key)>                          on_key_repeated {nullptr};
